 ...
 *
 * @see core.domain.camera.compose.rememberCameraKState
 * @see core.domain.camera.compose.CameraKScreen
 * @see core.domain.camera.state.CameraKState
 */
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "core.domain.camera.compose.rememberCameraKState",
        "core.domain.camera.state.CameraConfiguration",
    ),
