...
@Composable
fun SideMenuContentItemHorizontal(
    text: String,
    textStyle: TextStyle,
    ...
    Row(
        modifier = Modifier
            ...
            .padding(horizontal = sideMenuTheme.expandedItemStartPadding),
        verticalAlignment = Alignment.CenterVertically,
        horizontalArrangement = Arrangement.spacedBy(sideMenuTheme.expandedItemSpacedBy)
    ) {
        Icon(
